...
(def namespaces
  (cond->
    ...
    features/datalevin? (assoc 'datalevin.core @(resolve 'babashka.impl.datalevin/datalevin-core-namespace))
    features/core-logic? (assoc 'clojure.core.logic @(resolve 'babashka.impl.core-logic/core-logic-namespace)
                                'clojure.core.logic.protocols @(resolve 'babashka.impl.core-logic/core-logic-protocols-namespace)
                                'clojure.core.logic.arithmetic @(resolve 'babashka.impl.core-logic/core-logic-arithmetic-namespace)
                                'clojure.core.logic.fd @(resolve 'babashka.impl.core-logic/core-logic-fd-namespace)
                                'clojure.core.logic.pldb @(resolve 'babashka.impl.core-logic/core-logic-pldb-namespace)
                                'clojure.core.logic.unifier @(resolve 'babashka.impl.core-logic/core-logic-unifier-namespace))
